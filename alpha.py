...
if os.path.isfile("trait_selection.txt")=="false":
	...
	fw.write(str(0))
	fw.close()
if os.path.isfile("specialisation_selection.txt")=="false":
...
if os.path.isfile("trait_global_puissance.txt")=="false":
...
if os.path.isfile("trait_global_resistance.txt")=="false":
...
if os.path.isfile("specialisation_global_insaisissable.txt")=="false":
	...
	fw.write(str(1))
	fw.write("\n")
	fw.write(str("Votre vitesse augmente vos chances d'esquive (15% de votre vitesse)"))
	fw.close()

if os.path.isfile("specialisation_global_elementaire.txt")=="false":
...
if os.path.isfile("specialisation_global_sanguinaire.txt")=="false":
